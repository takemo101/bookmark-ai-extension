 ...
 * in the Warm Library direction: readable line height, gentle borders for
 * code/quotes/tables, restrained accent colors (docs/design.md "UI Design").
 */
...
/**
 * Article-style element overrides. Each override drops react-markdown's
 * `node` AST prop so it never reaches the DOM.
 */
const components: Components = {
	...
	th: ({ node: _node, ...props }) => (
		<th
			style={{ ...tableCell, background: palette.paperInset, fontWeight: 700 }}
			{...props}
		/>
	),
